...
public class CustomerProfile extends JFrame {
    ...
    private JButton addPersonalDataButton;
    ...
    private void showAddPersonalDataPanel() {
    ...
    private JPanel createButtonPanel() {
        ...
        addPersonalDataButton = new JButton("Add Personal Data");
        ...
        modifyUsernameButton.addActionListener(e -> {
            ...
            // Handle modify username action
        });

        modifyPasswordButton.addActionListener(e -> {
            showModifyPasswordPanel();
            // Handle modify password action
        });

        modifyEmailButton.addActionListener(e -> {
            showModifyEmailPanel();
            // Handle modify email action
        });

        addPersonalDataButton.addActionListener(e -> {
            showAddPersonalDataPanel();
            // Handle add personal data action
        });
        ...
        buttonPanel.add(addPersonalDataButton);
